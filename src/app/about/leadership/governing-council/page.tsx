        ...
        <div className="flex flex-col lg:flex-row">
          ...
          <div className="w-full lg:w-1/2 order-1 lg:order-2 p-4">
            <div className="relative w-full aspect-square">
              <Image
                src="/assets/governingCouncil/governingCouncil-2.jpg"
                fill
      ...
      <div>
        ...
        <div className="flex flex-col lg:flex-row">
          ...
          <div className="w-full lg:w-1/2 order-1 lg:order-2 p-4">
            <div className="relative w-full aspect-square">
              <Image
                src="/assets/governingCouncil/governingCouncil-3.jpg"
                fill
                alt="About Image preview"
                className="object-contain float-right"
              />
...
const GoverningCouncil = () => {
  return (
    <div>
      ...
      {/* image of school */}
      <ImageBanner src="/assets/governingCouncil/governingCouncil-1.jpg" />
      {/* dropdowns */}
