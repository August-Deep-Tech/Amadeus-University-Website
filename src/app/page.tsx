      ...
      <div className="ContentContainer">
        <div className="text-au-100-black flex flex-col gap-5 sm:gap-6 md:gap-[30px] py-10 sm:py-16 md:py-[77px] text-center">
          ...
          <p className="text-xl sm:text-lg md:text-[24px] leading-relaxed sm:leading-loose md:leading-[38px] font-light">
            Our vision is a flourishing Africa whose leaders make ethical
            decisions in the best interests of their communities, and where
            innovation drives economic, cultural and social growth. We educate
            leaders who will make this vision a reality, and we collaborate with
            other institutions to multiply this work.
          </p>
      ...
      <div className="bg-au-dark-grey py-[58px]">
        <div className="container mx-auto flex flex-col lg:flex-row justify-center">
          {[
            ...
            {value: "96%", description: "CAREER PLACEMENT"},
          ].map((stat, index) => (
            <div
              key={index}
              className={`text-center text-au-light-grey py-[20px] lg:px-[50px] ${
                index > 0 &&
                "border-t lg:border-l lg:border-t-0 border-au-light-grey "
              }`}
            >
