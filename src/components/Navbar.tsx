              ...
              {menuData.map((item, index) => (
                <li key={index} className="group">
                  <Link
                    ...
                    } py-[40px] -translate-y-1 px-4 mx-2 hover:transition-all hover:ease-in-out delay-150 group-hover:border-b-4 hover:border-au-burgundy ${
                      !isHome && item.name === currentPath && "border-b-4"
                    }  ${
                  ...
                  {item.submenu.length > 0 && (
                    <div>
                      ...
                      {(pathname === "/job-openings" ? isHome : !isHome) && (
                        <div
                          className={`absolute left-0 mt-[40px] w-[100%] text-au-white bg-au-burgundy hover:transition-all hover:ease-[cubic-bezier(0.4, 0, 0.2, 1)] duration-0 ${
                            pathname.startsWith(item.link) && "block z-[5]"
                          }`}
                        >
                          <div className="2xl:w-[1440px] 2xl:mx-auto px-5 2xl:px-0 flex justify-between items-center ">
                            <div className="py-4">
